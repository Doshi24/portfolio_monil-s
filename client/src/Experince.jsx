    ...
    <section id="experience" className="w-full md:w-[55%] py-20 px-6 bg-white/70 rounded-3xl shadow-2xl">
      ...
      <div className="max-w-4xl mx-auto text-gray-600">
        <ul className="space-y-4">
          <li className="text-purple-700 font-bold text-xl">
            <strong>Technical Support Intern</strong> – <strong> Credence Analytics </strong> (Feb 2025 – Sept)
          </li>
            <li>
              <ul className="list-disc list-inside space-y-2 text-gray-700 mt-2 text-xl">
